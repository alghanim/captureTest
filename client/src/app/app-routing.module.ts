...
import { CaptureEditComponent} from './pages/capture-edit/capture-edit.component';
...
const routes: Routes = [
    ...
    { path: 'captures/:id',  loadChildren: './pages/capture-edit/capture-edit.module#CaptureEditModule' , canActivate: [AuthGuard] },
