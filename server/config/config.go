...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("captureTest_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("captureTest.config") // Configuration fileName without the .TOML or .YAML extension
	}
