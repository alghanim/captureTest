...
import (
	...
	// CONFIG
	"skaffolder/captureTest/config"
	"skaffolder/captureTest/security"

	// start import model

	// APIs
	"skaffolder/captureTest/api/captureTest_db/user"
	"skaffolder/captureTest/api/captureTest_db/capture"
...
func Routes(configuration *config.Config) *chi.Mux {
	...
	router.Route("/api", func(r chi.Router) { 
		...
		r.Mount("/capture", capture.New(configuration).Routes())
	})
